...
export class Mundo{
    ...
    iluminar(){
      //  var luzAmbiental = new THREE.AmbientLight(0x404040); // Puedes ajustar el color según tus necesidades
       // this.escena.add(luzAmbiental);
       // this.escena.add( new THREE.AmbientLight( 0xffffff, 1 ) );
         var luzd = new THREE.DirectionalLight( 0xffddcc, 0 );
